...
- **NACE** : Nomenclature statistique des Activités économiques (NAF)
    - ~700 codes finaux
...
flowchart TD
  ...
  D01["Division 01 Culture et production animale"]
  D10["Division 10 Industries alimentaires"]
  
  G011["Groupe 01.1 Cultures non permanentes"]
  G101["Groupe 10.1 Conservation de la viande"]
  
  C0111["01.11 - Culture de céréales"]
  C1011["10.11 - Transformation viande"]
...
- **Monitoring** : c’est là que le bât blesse ❌  
  - Investissements humains importants  
...
- Un agent = un prompt, un type d'input et un type d'output
- Les *closers*
  - *CodeChooser*: 
  - *MatchVerifier*
- *Text2Code* (classifieur)
  - le *Navigator* hérite de *Text2Code*
