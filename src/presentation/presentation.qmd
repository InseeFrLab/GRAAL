...
## Les méthodes utilisées aujourd'hui nécessite des bases de données conséquentes


Dans le cas de la NACE, l'INSEE utilise un classifieur fast-text pré-entrainé avec une accuracy de 88% 
